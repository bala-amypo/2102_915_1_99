// src/main/java/com/example/demo/controller/AssetLifecycleEventController.java
...
public class AssetLifecycleEventController {
    ...
    @PostMapping("/{assetId}")
    public ResponseEntity<AssetLifecycleEvent> log(@PathVariable Long assetId,
                                                   @RequestBody AssetLifecycleEvent event) {
        return ResponseEntity.ok(eventService.logEvent(assetId, event));
    }

    @GetMapping("/asset/{assetId}")
    public ResponseEntity<List<AssetLifecycleEvent>> list(@PathVariable Long assetId) {
